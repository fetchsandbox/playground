# Acme Notifications — Claude Code project rules
...
2. Call `mcp__fetchsandbox__guide` FIRST with the stripped ask.
...
6. Re-run to confirm. Two receipt URLs = before/after proof.
